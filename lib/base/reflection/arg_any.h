...
struct ArgAny {
  ...
  void set(bool value) { _value.b = value; }

  void set(int8_t value) { _value.i8 = value; }

  void set(uint8_t value) { _value.u8 = value; }

  void set(int16_t value) { _value.i16 = value; }

  void set(uint16_t value) { _value.u16 = value; }

  void set(int32_t value) { _value.i32 = value; }

  void set(uint32_t value) { _value.u32 = value; }

  void set(int64_t value) { _value.i64 = value; }

  void set(uint64_t value) { _value.u64 = value; }

  void set(float value) { _value.f = value; }

  void set(double value) { _value.d = value; }
