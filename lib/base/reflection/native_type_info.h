...
#include "lib/base/reflection/field_info.h"
#include "lib/base/reflection/native_constructor_info.h"
#include "lib/base/reflection/native_property_info.h"
...
struct SGE_BASE_EXPORT NativeTypeInfo final : TypeInfo {
  ...
  struct Data {
    InitFn* init = nullptr;
    CopyInitFn* copy_init = nullptr;
    MoveInitFn* move_init = nullptr;
  ...
  bool has_init() const override { return _data.init != nullptr; }

  void init(void* addr) const override { _data.init(addr); }

  bool has_copy_init() const override { return _data.copy_init != nullptr; }

  void copy_init(void* addr, const void* copy) const override { return _data.copy_init(addr, copy); }

  bool has_move_init() const override { return _data.move_init != nullptr; }

  void move_init(void* addr, void* move) const override { _data.move_init(addr, move); }

  bool has_copy_assign() const override { return _data.copy_assign != nullptr; }

  void copy_assign(void* self, const void* copy) const override { _data.copy_assign(self, copy); }

  bool has_move_assign() const override { return _data.move_assign != nullptr; }

  void move_assign(void* self, void* move) const override { return _data.move_assign(self, move); }

  bool has_drop() const override { return _data.drop != nullptr; }

  void drop(void* self) const override { _data.drop(self); }

  bool has_equality_compare() const override { return _data.equality_compare != nullptr; }

  bool equality_compare(const void* lhs, const void* rhs) const override {
    return _data.equality_compare(lhs, rhs);
  }

  size_t num_constructors() const override { return _data.constructors.size(); }
  ...
  size_t num_named_constructors() const override { return _data.named_constructors.size(); }
  ...
  size_t num_properties() const override { return _data.properties.size(); }
  ...
  size_t num_fields() const override { return _data.fields.size(); }
