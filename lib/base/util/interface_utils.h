...
struct SelfMut {
  ...
  void* ptr() const { return _self; }

  bool null() const { return _self == nullptr; }
...
struct Self {
  Self(const void* self) : _self(self) {}

  Self(SelfMut self) : _self(self.ptr()) {}
  ...
  const void* ptr() const { return _self; }
